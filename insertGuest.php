...
$CompName =  $_POST['GuestCompany'];
$GuestName =  $_POST['GuestName'];
$GuestEmail =  $_POST['GuestEmail'];
$GuestTel =  $_POST['GuestTel'];
$GuestTelBackup =  $_POST['GuestTelBackup'];
$LineID =  $_POST['LineID'];
$DataIn =  $_POST['DataIn'];
$TimeIn =  $_POST['TimeIn'];
...
$MenuOther1 =  $_POST['MenuOther1'];
$MenuOther2 =  $_POST['MenuOther2'];
$MenuOther3 =  $_POST['MenuOther3'];
$ListPrice =  $_POST['ListPriceSel'];
if ($ListPrice == '') {
    $ListPrice = 0;
}
...
$RiceVIP =  $_POST['RiceVIP'];
$FruitVIP =  $_POST['FruitVIP'];
$DrinkVIP =  $_POST['DrinkVIP'];
$BKStatus =  $_POST['BKStatus'];
...
$sql = $conn->prepare("INSERT INTO guest(GuestCompany,GuestName,GuestEmail,GuestTel,GuestTelBackup,GuestLine,DataIn,TimeIn,TimeRange,GuestNum, TotalPrice,Pledge,GuestType,GuestStatus)  
                                VALUES('$CompName','$GuestName','$GuestEmail','$GuestTel','$GuestTelBackup','$LineID','$DataIn','$TimeIn','$TimeRange','$GuestNum', '$TotalPrice','$Pledge','$GuestType','1')");
$sql->execute();
...
foreach ($_POST['TableID'] as $row => $art) {
    ...
    $sql2 = $conn->prepare("INSERT INTO bookingres(GuestID,TableID,ResName,DataIn,TimeIn,TimeRange,ListPrice,RecordBy,MenuOther,MenuName1,MenuName2,MenuName3,MenuName4,MenuName5,MenuName6,MenuName7,MenuName8,MenuName9,MenuName10,BKStatus)
                                    VALUES('$LastID','$TableID','$ResName','$DataIn','$TimeIn','$TimeRange','$ListPrice','$RecordBy','$MenuOther1$MenuOther2$MenuOther3$RiceVIP$FruitVIP$DrinkVIP','$MenuName1','$MenuName2','$MenuName3','$MenuName4','$MenuName5','$MenuName6','$MenuName7','$MenuName8','$MenuName9','$MenuName10$Rice$Fruit$Drink','$BKStatus')");
    $sql2->execute();
    ...
    $sql = $conn->prepare("UPDATE `tablemantraplan` SET `TableStatus`='1', `UserRecord`='' WHERE `TableID`='$TableID'");
    $sql->execute();
...
if ($sql && $sql2) {
    ...
    <script type="text/javascript">
        ...
        $(function() {
            alertify.showSuccess('เพิ่มข้อมูลการจองลูกค้าผิดพลาด โปรดกรอกข้อมูลให้ครบ<br/><br/>',
                function(e) {
                    if (e) {
