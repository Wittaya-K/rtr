                        ...
                        <div class="card">
                            <div class="card-contect">
                                <div class="card-body">
                                    ...
                                    <div class="header">
                                        <h4 class="title" style="font-family: 'Trirong', serif;">แผนผังร้าน</h4>
                                    </div>
                                                    ...
                                                    <tr><label class="control-label" for="input4" style="font-size:16px; color: black;">เลือกวันที่และช่วงเวลา :</label>
                                                        <td style="width:100%;">
                                                            ...
                                                            <select name="SelectTime" id="SelectTime" class="toggle-divs form-control border-input" style="text-align-last: center;" required>
                                                                ...
                                                                <option value="08:00 - 12:00 น.">ช่วงสาย 08:00 - 12:00 น.</option>
                                                ...
                                                <div class="portfolio">
                                                    <div class="Loft1">
                                                        <a href="Include/GetSession.php?ZoneName=LoftWaterFront">
                                                            <img src="images/MantraPlan/Table.drawio.png" style="width: 100%; object-fit: contain"></a>
                                                    </div>
                                                    <!-- <div class="Loft2">
                                                <a href="Include/GetSession.php?ZoneName=LoftFrontStage">
                                                    <img src="images/MantraPlan/Loft2.png" style="width: 100%; object-fit: contain"></a>
                                            </div>
                                            <div class="Loft3">
                                                <a href="Include/GetSession.php?ZoneName=LoftInHome">
                                                    <img src="images/MantraPlan/Loft3.png" style="width: 100%; object-fit: contain"></a>
                                            </div>
                                            <div class="Loft5">
                                                <img src="images/MantraPlan/Loft5.png" style="width: 100%; object-fit: contain">
                                            </div>
                                            <div class="Loft6">
                                                <img src="images/MantraPlan/Loft6.png" style="width: 100%; object-fit: contain">
                                            </div>
                                            <div class="Loft7">
                                                <a href="Include/GetSession.php?ZoneName=LoftEdgePool">
                                                    <img src="images/MantraPlan/Loft7.png" style="width: 100%; object-fit: contain"></a>
                                            </div>
                                            <div class="Loft8">
                                                <a href="Include/GetSession.php?ZoneName=LoftCoffreeBar">
                                                    <img src="images/MantraPlan/Loft8.png" style="width: 100%; object-fit: contain"></a>
                                            </div>
                                            <div class="Loft9">
                                                <img src="images/MantraPlan/Loft9.png" style="width: 100%; object-fit: contain">
                                            </div>
                                            <div class="Loft10">
                                                <a href="Include/GetSession.php?ZoneName=LoftLevel2">
                                                    <img src="images/MantraPlan/Loft10.png" style="width: 100%; object-fit: contain"></a>
                                            </div>
                                            <div class="Loft11">
                                                <a href="Include/GetSession.php?ZoneName=LoftKaraoke">
                                                    <img src="images/MantraPlan/Loft11.png" style="width: 100%; object-fit: contain"></a>
                                            </div> -->
                                                </div>
                                            </div>
                                        </div>
