...
?>
<!-- Modal -->
<div class="modal fade text-left w-100 modal-borderless" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="card-header">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <div class="list-group">
                                            <a href="./LoftWaterFront.php" class="list-group-item list-group-item-action <?php if ($idgroup == null) { ?>active<?php } ?>">ทั้งหมด(<?php echo $resultCheckCountAll[0] ?>)</a>
                                            <?php
                                            $WOverFlow = 3;
                                            foreach ($resultGETGroupMenu as $keyresultGETGroupMenu => $valueresultGETGroupMenu) { ?>
                                                ...
                                                ?>
                                                <a href="./LoftWaterFront.php?idgroup=<?php echo $valueresultGETGroupMenu['group_id'] ?>" class="list-group-item list-group-item-action <?php if ($idgroup == $valueresultGETGroupMenu['group_id']) { ?>active<?php } ?>"><?php echo $valueresultGETGroupMenu['group_name'] ?>(<?php echo $resultCheckCount[0] ?>)</a>
                                            <?php $WOverFlow++;
                                            } ?>
                                        </div>
                                    </ul>
                                ...
                                <div class="mt-3 groupMEnu" id="groupcontainer" style="width: 100%;overflow: auto;padding-bottom: 3px;">
                                    <div style="width: <?php echo $WOverFlow ?>00px;">
                                        ...
                                        <?php foreach ($resultGETGroupMenu as $keyresultGETGroupMenu => $valueresultGETGroupMenu) { ?>
                                            ...
                                            ?>
                                            <a href="./LoftWaterFront.php?idgroup=<?php echo $valueresultGETGroupMenu['group_id'] ?>">
                                            ...
                                            <div class="modal fade" id="ModaladdCart<?php echo $valueresultGETMenu['menu_id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        // SQL GET Sub menu
                                                        $sqlGETSubMenu = $conn->prepare("SELECT `sm_id`,`sm_name`,`sm_price` FROM `rtr_sub_menu` WHERE `menu_id`=$menu_id");
                                                        ...
                                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                                            <form action="./action.php" method="post">
                                                                <div class="form-group">
                                                                    ...
                                                                    $datenow = date('Y-m-d');
                                                                    // SQL GET Order
                                                                    $sqlGETOrder = $conn->prepare("SELECT `od_id` FROM `rtr_order` WHERE `date`='$datenow'");
                                                                    $sqlGETOrder->execute();
                                                                ...
                                                                FROM
                                                                    (SELECT 
                                                                        tablemantraplan.*, bookingres.BKStatus
                                                                    FROM
                                                                        tablemantraplan
                                                                    LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID
                                                                    WHERE
                                                                        bookingres.DataIn = '$_SESSION[SelectDate]'
                                                                            AND bookingres.TimeRange = '$_SESSION[SelectTime]'
                                                                            AND tablemantraplan.TableZone = '1'
                                                                            AND tablemantraplan.TableGroup = 'A'
                                                                            AND tablemantraplan.ResName = 'Loft' UNION ALL SELECT 
                                                                        tablemantraplan.*, tablemantraplan.TableStatus
                                                                    FROM
                                                                        tablemantraplan
                                                                    LEFT JOIN bookingres ON tablemantraplan.TableID = bookingres.TableID
                                                                    WHERE
                                                                        TableZone = '1' AND TableGroup = 'A'
                                                                            AND tablemantraplan.ResName = 'Loft') AS TBid
                                                                GROUP BY TBid.TableID
                                                                ORDER BY TBid.Orders ASC");
                                                                    $sql->execute();
                                                                    $rssql = $sql->fetchAll();
                                                                    ?>
                                                                    ...
                                                                    <select name="numberSeat" id="numberSeat" class="form-control" required>
                                                                        ...
                                                                        <?php foreach ($rssql as $keyrssql => $valuerssql) {
                                                                            $NewVar = (int)substr($valuerssql["TableNumber"], 3, 2);
                                                                        ?>

                                                                            <option value="<?php echo $valuerssql["TableNumber"] ?>" style="color: green;"><?php echo $NewVar . ' - ว่าง' ?></option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="numberSeat" id="numberSeat" class="form-control" required>
                                                                        ...
                                                                        <?php foreach ($resultGETSeat2 as $keyresultGETSeat2 => $valueresultGETSeat2) { ?>
                                                                            ...
                                                                            // SQL GET Order
                                                                            $sqlGETOrderSeat2 = $conn->prepare("SELECT * FROM `rtr_order` WHERE `od_status`='false' AND `seat_id`=$seatID AND `sh_number`=$idshift");
